...
clean_df_python = read_csv("C:\\Users\\internet\\Desktop\\clean_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
transformed_df_python = read_csv("C:\\Users\\internet\\Desktop\\transformed_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
global_df_python = read_csv("C:\\Users\\internet\\Desktop\\global_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
temp = global_df %>% 
  select(names(global_df_python), -starts_with("global"))

if(isTRUE(all.equal(global_df %>%
                    select(
                      names(global_df_python),-starts_with("global")
                      ),
                    global_df_python %>% 
...
crisis_df_python = read_csv("C:\\Users\\internet\\Desktop\\crisis_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
