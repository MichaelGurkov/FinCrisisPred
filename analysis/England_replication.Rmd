...
clean_df_python = read_csv("C:\\Users\\micha\\Desktop\\clean_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
if(isTRUE(all.equal(clean_df %>% 
            filter(complete.cases(.)),
          clean_df_python %>% 
            filter(complete.cases(.))))){print("Clean df - passed")}
...
transformed_df_python = read_csv("C:\\Users\\micha\\Desktop\\transformed_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
if(isTRUE(all.equal(transformed_df %>% 
            select(names(transformed_df_python)) %>% 
            filter(complete.cases(.)),
          transformed_df_python %>% 
            filter(complete.cases(.))))){print("Transformed df - passed")}
...
global_df_python = read_csv("C:\\Users\\micha\\Desktop\\global_df.csv",
                           col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso = col_character()
...
if(isTRUE(all.equal(global_df %>% 
            ...
            filter(complete.cases(.)),
          global_df_python %>% 
            filter(complete.cases(.))))){print("Global df - passed")}
